...
export const coreBenefitsData: CoreBenefitType[] = [
  {
    ...
    description:
      "Open Algotrade equips developers with the latest tools to rapidly build scalable, modern dashboards with less friction.",
    points: [
  ...
  },
  {
    ...
    description:
      "With customizable themes and built-in accessibility, Open Algotrade adapts seamlessly to your team’s needs and user diversity.",
    points: [
  ...
  },
  {
    ...
    description:
      "Open Algotrade includes essential, production-ready features like authentication, form validation, and rich data components.",
    points: [
